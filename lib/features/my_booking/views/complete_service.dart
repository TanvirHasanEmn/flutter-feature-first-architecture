...
import '../controllers/complete_service_controller.dart';
import 'cancelled_dialog.dart';


class CompleteServicePage extends StatelessWidget {
  final String bookingId;
  final lang = Get.find<LocalizationController>();

  // ✅ Correctly inject the real bookingId into controller
  late final CompleteServiceController controller;

  CompleteServicePage({super.key, required this.bookingId}) {
    controller = Get.put(CompleteServiceController(bookingId: bookingId));
  }
